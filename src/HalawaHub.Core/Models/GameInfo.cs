...
public class GameInfo
{
    ...
    /// رابط احتياطي يُجرَّب لو فشل تحميل CoverImageUrl (مثلاً: صيغة أفقية
    /// بدل عمودية لبعض ألعاب Steam القديمة اللي ما عندها غلاف مكتبة عمودي)
    public string? CoverImageUrlFallback { get; set; }
